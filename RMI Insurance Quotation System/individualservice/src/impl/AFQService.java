...
public class AFQService extends AbstractQuotationService implements QuotationService {
	...
	public static void main(String args[]) throws RemoteException {
		...
		afq = (QuotationService) UnicastRemoteObject.exportObject(new AFQService(), 0);
		try {
			if (registry != null) {
	...
	/**
	 * Quote generation: 30% discount for being male 2% discount per year over
	 * 60 20% discount for less than 3 penalty points 50% penalty (i.e.
	 * reduction in discount) for more than 60 penalty points
	 */
	@Override
